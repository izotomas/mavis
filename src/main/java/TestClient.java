...
public class TestClient {
  ...
  final static String[] ACTIONS = {"NoOp",
      ...
      "Push(N,N)", "Push(N,E)", "Push(N,W)", "Push(S,S)", "Push(S,E)", "Push(S,W)", "Push(E,N)",
      "Push(E,S)", "Push(E,E)", "Push(W,N)", "Push(W,S)", "Push(W,W)",

      "Pull(N,N)", "Pull(N,E)", "Pull(N,W)", "Pull(S,S)", "Pull(S,E)", "Pull(S,W)", "Pull(E,N)",
      "Pull(E,S)", "Pull(E,E)", "Pull(W,N)", "Pull(W,S)", "Pull(W,W)"};
