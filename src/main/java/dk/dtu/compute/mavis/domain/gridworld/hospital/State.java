...
/**
 * Compact data class for storing non-static state information. Every instance
 * belongs to a StateSequence, which tracks the static state information.
 */
class State {
  /**
   * Box locations. Indexed by box id (0 .. numBoxes-1).
   */
  short[] boxRows;
  short[] boxCols;

  /**
   * Agent locations. Indexed by agent id (0 .. numAgents-1).
   */
  short[] agentRows;
  short[] agentCols;
