...
public class Fonts {
  ...
  /**
   * Returns a global instance of the DejaVu Sans Mono (Bold) font, loaded on the
   * first call. Returns null and writes an error to Server.printError if the font
   * can't be loaded.
   */
  public synchronized static Font getDejaVuSansMono() {
    if (dejaVuSansMono == null) {
      try {
        ...
        Server.printDebug(
            "Loaded DejaVu Sans Mono font in: " + fontLoadElapsed / 1_000_000L + " ms.");
