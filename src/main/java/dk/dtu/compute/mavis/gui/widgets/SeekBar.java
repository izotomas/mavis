...
public class SeekBar extends JComponent {
  ...
  /**
   * Value can be set higher than maxValue, in which case it draws as if capped at
   * maxValue, but adapts when maxValue is later adjusted.
   */
  ...
  /**
   * Returns whether the value has changed as a result of user interaction, and
  ...
  private class SeekBarHandler extends MouseAdapter {
    @Override
